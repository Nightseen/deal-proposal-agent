...
**Párrafo de visión (`parrafoVision`, sección 03)**: nunca uses la palabra "imaginamos" ni frasees el párrafo como una condición hipotética ("imagina que...", "¿te imaginas...?"). Es la visión que el cliente ya nos contó que quiere lograr, no una invitación a imaginar — redáctala en afirmativo, como algo hacia lo que se está trabajando.
